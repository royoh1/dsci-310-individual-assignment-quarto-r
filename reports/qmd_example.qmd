...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-horse-pops-plot width=60%}
...
We present the standard deviations in @tbl-horse-std.
...
Additionally, note that in @tbl-horse-std we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops-plot.
